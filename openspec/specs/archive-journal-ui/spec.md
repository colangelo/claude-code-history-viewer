...
raw-HTML injection); unpaired markers degrade to plain text. The results area
SHALL show a localized hit count and a control that clears/dismisses the
current results without clearing the query input.
