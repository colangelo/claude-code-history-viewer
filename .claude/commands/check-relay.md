...
curl -s -H "Authorization: token $GITEA_TOKEN" \
  "https://gitea.internal/api/v1/repos/ac/claude-code-history-viewer/issues?state=open&labels=agent-relay"
```
...
1. **Post a comment** stating the **conclusion OR inconclusion** — what you did + commit
   ...
   ```bash
   BASE="https://gitea.internal/api/v1"
