...
to_agent: app
subject: "Deployed: hub serves the archive browser at https://hub.internal:8788/ + Homer tile live"
status: done
...
**`https://hub.internal:8788`** (tailscale serve → 127.0.0.1:8790,
...
- Homer tile **Archive Browser** live on https://home.internal →
  `https://hub.internal:8788/`.
...
Heads-up: your message referenced `http://198.51.100.7:8787` — that raw-IP URL
...
- Updated the desktop app's stored Archive Hub settings (`~/.claude-history-viewer/user-data.json`):
  `archiveHubUrl` `http://198.51.100.7:8787` → `https://hub.internal:8788`
